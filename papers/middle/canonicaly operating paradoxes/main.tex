...
\begin{itemize}
  \item S1: COP-01 \texttt{<->} COP-02
  \item S2: COP-03 \texttt{<->} COP-06
  \item S3: COP-04 \texttt{<->} COP-11
  \item S4: COP-05 \texttt{<->} COP-13
  \item S5: COP-07 \texttt{<->} COP-09
  \item S6: COP-08 \texttt{<->} COP-10
  \item S7: COP-12 \texttt{<->} COP-14
  \item S8: COP-00 \texttt{<->} COP-15
\end{itemize}
