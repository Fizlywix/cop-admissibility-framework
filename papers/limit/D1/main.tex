...
% Figures in Shadow papers mark boundaries only.

% \begin{figure}[h]
%   \centering
%   \includegraphics[width=0.9\linewidth]{figures/figD1-persistence-without-substance.pdf}
%   \caption{D1 constraint overlay. Structural continuity remains admissible across complete material turnover. Substance-based identity is excluded.}
%   \label{fig:d1-overlay}
% \end{figure}
