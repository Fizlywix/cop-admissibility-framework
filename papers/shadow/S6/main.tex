...
\begin{itemize}
  \item \textbf{Forward constraint:} COP-06 (Commitment Replaces Consensus),
  \item \textbf{Reverse constraint:} ICOP-06 (Not All Actions Exist).
\end{itemize}
...
\subsection{Forward: COP-06 Commitment Replaces Consensus}
...
\subsection{Reverse: ICOP-06 Not All Actions Exist}

ICOP-06 constrains reverse legibility:
...
They become detectable non-locally as endless deliberation,
symbolic gestures without effect, or action overcounting.
...
\begin{itemize}
  \item If agreement substitutes for commitment, stop (COP-06).
  \item If intention substitutes for action, stop (ICOP-06).
