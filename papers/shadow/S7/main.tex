...
\begin{itemize}
  \item \textbf{Forward constraint:} COP-07 (Unity Is Coordinated Multiplicity),
  \item \textbf{Reverse constraint:} ICOP-07 (Healthy Systems Require Limiters).
\end{itemize}
...
\subsection{Forward: COP-07 Unity Is Coordinated Multiplicity}
...
\subsection{Reverse: ICOP-07 Healthy Systems Require Limiters}

ICOP-07 constrains reverse legibility:
...
They become detectable non-locally as pressure toward full integration,
suppression of limiting signals, or brittleness following expansion.

Such signals are diagnostic only.
They must not be narrativized.
...
\begin{itemize}
  \item If unity is pushed toward total integration, stop (COP-07).
  \item If limits are treated as defects, stop (ICOP-07).
