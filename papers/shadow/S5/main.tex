...
\begin{itemize}
  \item \textbf{Forward constraint:} COP-07 (Structural Unity, Functional Plurality),
  \item \textbf{Reverse constraint:} COP-09 (Agency Is Produced, Not Granted).
\end{itemize}
...
\subsection{Forward: COP-07 Structural Unity, Functional Plurality}
...
\subsection{Reverse: COP-09 Agency Is Produced}

COP-09 constrains reverse legibility:
...
\begin{itemize}
  \item role confusion or collapse,
  \item claims of inherent authority,
  \item persistence of agency without operational backing,
  \item attempts to equalize function across roles.
\end{itemize}

These are not local errors.
They are structural boundary signals.
...
\begin{itemize}
  \item If unity is treated as uniformity, stop (COP-07).
  \item If agency is treated as inherent, stop (COP-09).
...
\begin{figure}[h]
  \centering
  % Placeholder for structural unity / plurality overlay
...
\begin{figure}[h]
  \centering
  % Placeholder for agency-production slice
